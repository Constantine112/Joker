  ...
  <div class="divlogin">
    <div class="log-contain">
      <h2 class="log-h2">基于智能打印机的并行打印集群应用</h2>
    	<div id="login">
        <input type="text" id="userAccount" name="userAccount" required v-model="userAccount" style="width: 60%; margin: 10px;" placeholder="请输入你的用户名" class='change'/>
        <input type="password" id="userPassword" name="userPassword" required v-model="userPassword" style="width: 60%; margin: 10px;" placeholder="请输入你的密码" />
